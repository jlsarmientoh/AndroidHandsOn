 ...
 * {@link BitmapCache#getInstance(FragmentManager, ImageCacheParams)} to get an instance of this
...
public class BitmapCache {
     ...
     * {@link BitmapCache#getInstance(FragmentManager, ImageCacheParams)} to fetch an ImageCache
     * instance.
     *
     * @param cacheParams The cache parameters to use to initialize the cache
     */
    private BitmapCache(ImageCacheParams cacheParams) {
        init(cacheParams);
    }

    /**
     * Return an {@link BitmapCache} instance. A {@link RetainFragment} is used to retain the
    ...
    public static BitmapCache getInstance(
        ...
        BitmapCache imageCache = (BitmapCache) mRetainFragment.getObject();

        // No existing ImageCache, create one and store it in RetainFragment
        if (imageCache == null) {
            imageCache = new BitmapCache(cacheParams);
    ...
    public static class ImageCacheParams {
         ...
         * {@link BitmapCache#getInstance(FragmentManager, ImageCacheParams)} or
         * {@link ImageWorker#addImageCache(FragmentManager, ImageCacheParams)}.
