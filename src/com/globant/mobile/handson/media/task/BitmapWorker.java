...
public abstract class BitmapWorker {
     ...
     * disk cache will be used if an {@link BitmapCache} has been added using
     * {@link ImageWorker#addImageCache(FragmentManager, BitmapCache.ImageCacheParams)}. If the
    ...
    /**
     * Adds an {@link BitmapCache} to this {@link ImageWorker} to handle disk and memory bitmap
     * caching.
    ...
    public void addImageCache(FragmentManager fragmentManager,
        ...
        mImageCache = BitmapCache.getInstance(fragmentManager, mImageCacheParams);
     ...
     * {@link BitmapCache.ImageCacheParams#ImageCacheParams(Context, String)}.
     */
    public void addImageCache(FragmentActivity activity, String diskCacheDirectoryName) {
        mImageCacheParams = new BitmapCache.ImageCacheParams(activity, diskCacheDirectoryName);
        mImageCache = BitmapCache.getInstance(activity.getSupportFragmentManager(), mImageCacheParams);
        new CacheAsyncTask().execute(MESSAGE_INIT_DISK_CACHE);
    }
    ...
    /**
     * @return The {@link BitmapCache} object currently being used by this ImageWorker.
     */
